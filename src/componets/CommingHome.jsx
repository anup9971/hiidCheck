      ...
      <div className="max-w-7xl mx-auto  flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="md:w-1/2  ">
         ...
         <div className="md:w-1/2  md:text-left">
          <h2 className="text-xl font-semibold  md:text-3xl font-serif text-gray-700 mb-1">
           Corporate Hotel Reservations, A New Approach for Professionals in Delhi.
          </h2>
          <p className="text-md   md:text-xl font-serif text-gray-700  mb-1">The smarter way for businesses to book rooms and conference spaces  crafted for Delhi, Mahipalpur, and Karol Bagh’s modern workforces.</p>
          <p className="text-gray-500 text-justify  text-base leading-relaxed">
