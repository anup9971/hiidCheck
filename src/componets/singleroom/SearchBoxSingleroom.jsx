...
export default function SearchBoxSingleroom({ bookingData }) {
  ...
  // ✅ submit (save bookingData + go to booking page)
  const handleSubmit = (e) => {
    e.preventDefault();
  ...
  return (
    <section className="w-full text-black py-6 px-3 md:px-12 lg:px-24">
      {/* 🖥️ Desktop */}
      <form
        onSubmit={handleSubmit}
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-green-700 text-white py-3 px-4 rounded-md hover:bg-green-800 transition"
        >
          Reserve
        </button>
      </form>
      ...
      <div className="md:hidden space-y-3 bg-white p-4 rounded-2xl shadow-lg">
        ...
        <button
          ...
          className="w-full py-3 rounded-xl bg-green-700 text-white font-bold shadow-md"
        >
          Reserve
        </button>
      </div>
      ...
      {showDateModal && (
        <div className="fixed inset-0 bg-white z-50 flex flex-col p-6">
          ...
          <button
            ...
            className="mt-auto py-3 rounded-xl bg-green-700 text-white font-bold"
          >
            Done
          </button>
        </div>
