  ...
  return (
    <div className="border rounded shadow hover:shadow-lg transition p-3 bg-white flex flex-col md:flex-row gap-4">
      ...
      <div className="flex flex-col justify-between flex-1">
        <div>
          <h3 className="text-lg text-gray-700 font-bold">{rooms?.name}</h3>
          <p className="text-sm text-gray-500">{rooms?.location}</p>
