      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/about" className="text-white hover:text-gray-300 hover:border-b-1">About Us</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/owner-registration" className="text-white hover:text-gray-300 hover:border-b-1">Add Your Property</Link></li>
          </ul>
        </div>
